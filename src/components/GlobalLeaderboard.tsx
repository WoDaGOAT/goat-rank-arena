    ...
    <Card className="shadow-2xl bg-white/10 backdrop-blur-sm border border-white/20 w-full">
      ...
      <CardContent className="p-0">
        {shouldShowInsufficientMessage ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 px-4 sm:px-6 text-center min-h-[200px]">
            <div className="text-white">
              <h3 className="text-lg font-bold mb-2">Leaderboard Loading</h3>
