  ...
  return (
    <Card className="shadow-2xl bg-white/10 backdrop-blur-sm border border-white/20">
      ...
      <CardContent className="p-0">
        {/* Header row */}
        <div className="grid grid-cols-[50px_60px_1fr_60px_80px] gap-3 items-center px-4 py-3 bg-white/5 border-b border-white/20 text-xs font-bold text-gray-300 uppercase tracking-wide">
