...
-- Add the year_of_birth column as integer
ALTER TABLE public.athletes ADD COLUMN year_of_birth INTEGER;

-- Migrate existing data from date_of_birth to year_of_birth
UPDATE public.athletes 
SET year_of_birth = EXTRACT(YEAR FROM date_of_birth)
WHERE date_of_birth IS NOT NULL;

-- Drop the old date_of_birth column
ALTER TABLE public.athletes DROP COLUMN date_of_birth;

-- Update the search_athletes_admin function to return the correct column
